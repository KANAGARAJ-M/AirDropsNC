...
//       // Save data to 'user_backup' collection
//       if (doc.exists) {
//         FirebaseFirestore.instance.collection('user_backup').doc(userId).set(doc.data()!);
//       }
...
//       // After fetching, back up the data into a new collection 'userBackups'
//       if (userData != null) {
...
//   // Function to back up user data to a new collection
//   Future<void> _backupUserData(String? userId) async {
//     if (userId != null && userData != null) {
//       try {
//         // Create a new document in 'userBackups' with the user data
