...
class AuthService {
  ...
  Future<Map<String, dynamic>?> loginWithEmailOrUsername(String emailOrUsername, String password, String referralCode) async {
    try {
      UserCredential result = await _auth.signInWithEmailAndPassword(email: emailOrUsername, password: password);
      User? user = result.user;
